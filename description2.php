  ...
  <head>
    ...
    <body class="background">
        ...
        <?php if (isset($_SESSION['mail'])) :?>
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/L1.jpg" class="d-block w-100 img-fluid" alt="Aconitum napellus 1">
                        </div>
                        <div class="carousel-item">
                            <img src="img/L2.jpg" class="d-block w-100 img-fluid" alt="Aconitum napellus 2">
                        </div>
                        <div class="carousel-item">
                            <img src="img/L3.jpg" class="d-block w-100 img-fluid" alt="Aconitum napellus 3">
                        </div>
                    <div>
            ...
            <div class="container">
                <p class="h1 text-center mt-2"> Le Laurier rose </p>
            </div>
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0 mb-1">Son histoire </h5>
                    <p class="mb-3">Dans le Midi, le laurier rose est parfois utilisé comme mort au rat. C'est dire... L'ingestion d'une simple feuille peut provoquer des troubles cardiaques risquant d'entraîner la mort. Ces effets résultent de la présence dans toutes les parties du laurier-rose de substances cardiotoniques. Cette plante est d'autant plus dangereuse qu'elle peut être confondue avec le laurier sauce utilisé en cuisine. En cas de doute, n'hésitez donc pas à demander conseil à votre pharmacien.</p>

                    <p> Les feuilles du laurier rose sont aussi reconnues pour leur toxicité. L'ingestion d'une seule d'entre elles par un adulte peut entraîner des vomissements, des diarrhées, des troubles cardiaques et être mortelle. </p>
            ...
            <div class="media">
                <div class="media-body">
                    ...
                    <p class="mb-3">Il est connu pour sa toxicité depuis l'Antiquité. En effet, des soldats grecs, mais aussi des troupes de Pompée, auraient souffert d'empoisonnement par consommation de miel de rhododendron. L'ingestion de feuilles de cet arbuste provoque des brûlures dans la bouche, des nausées, des vomissements et des douleurs abdominales. Les cas les plus graves peuvent conduire au décès.</p>
